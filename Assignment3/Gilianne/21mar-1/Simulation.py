...
class simulation:
    ...
    def simulate(self, T):
        ...
        a0 = self.arrDist0.rvs()
        # a1 = self.arrDist1.rvs()
        # a2 = self.arrDist2.rvs()
        # a3 = self.arrDist3.rvs()
        # a4 = self.arrDist4.rvs()
        firstEvent = Event(Event.ARRIVAL, a0)
        # secondEvent = Event(Event.Arrival, a1)
        # thirdEvent = Event(Event.ARRIVAL, a2)
        # fourthEvent = Event(Event.Arrival, a3)
        # fifthEvent = Event(Event.ARRIVAL, a4)
