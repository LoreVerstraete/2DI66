...
class Event:
    ''' Describes events of the simulation '''
    ...
    def __str__(self):
        ''' 
        Returns valuable strings with information of the event
        '''
        if self.type == Event.CUSTOMER_ARRIVAL:
            ...
            return "Elevator " + str(self.elevatorNr) + " is at floor " + str(self.floor) + " at time " + str(self.time)
