...
class simulation:
    ...
    def sim(poissonratearrivals, totalTime, meangroupsize, meanFood, cashpayments, meancash, meancard):
        ...
        for i in range(len(customerInfoSortqueue)):
            ...
            customerInfoIndiv = service.servicetime(meancash, meancard,customerInfoIndiv)
