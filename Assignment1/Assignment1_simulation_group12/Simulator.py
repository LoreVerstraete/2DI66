...
class Simulator:
    ...
    def Sim(board, boardpiece, boardcolor, columsMoves, strategy):
        ...
        print("Half-width player 1 wins", 1.96*sqrt(var(results == 1)/nrRuns))
        print("Confidence interval player 1 using formula", lb1, ",", ub1)
        ...
        print("Half-width player 2 wins", 1.96*sqrt(var(results==2)/nrRuns))
        print("Confidence interval player 2 using formula", lb2, ",", ub2)
        ...
        print("Half-width draw", 1.96*sqrt(var(results==3)/nrRuns))
        print("Confidence interval draw using formula", lb3, ",", ub3)
        ...
        print("Half-width", 1.96*sqrt(var(extraQueens)/nrRuns))
        ...
        print("Half-width number of moves", 1.96*sqrt(var(nrMoves)/nrRuns))
        print("Confidence interval number of moves using formula", lb5, ",", ub5)
        ci5 = DescrStatsW(nrMoves).tconfint_mean(alpha=0.05)
        print("Confidence interval number of moves using function", ci5)
        print("  ")
        ...
        if len(indexWhiteWins)>0:
            ...
            for i in indexWhiteWins:
                ...
                print("Confidence interval number of moves when white wins", meanwins - halfWidthWhite, meanwins + halfWidthWhite)
...
# print(Simulator.Sim(b.board, b.boardpiece, b.boardcolor, b.columsMoves, Piece.STRATEGY_PAWN2))